...
namespace SplashKitSDK
{
  public static class SplashKit
  {
    ...
    public static void DrawBitmap(string name, double x, double y, DrawingOptions scale)
    {
      __sklib_string __skparam__name;
      double __skparam__x;
      double __skparam__y;
    ...
    public static void DrawBitmap(string name, double x, double y, int v, DrawingOptions opts)
    {
      __sklib_string __skparam__name;
      double __skparam__x;
      double __skparam__y;
